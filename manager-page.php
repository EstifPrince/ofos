...
include 'includes/connect.php';
	...
	if($_SESSION['manager_sid']==session_id())
	{
		?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="row">
              ...
              <div>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<td><div class="input-field col s12 "><label for="'.$row["id"].'_picture_location">Picture Location</label>';
					echo '<input value="'.$row["picture_location"].'" id="'.$row["id"].'_picture_location" name="'.$row['id'].'_picture_location" type="text"</td>';                   
					echo '<td>';
					if($row['deleted'] == 0){
						$text1 = 'selected';
            $text2 = '';
