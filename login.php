...
if(isset($_SESSION['admin_sid']) || 
    isset($_SESSION['customer_sid']) || 
    isset($_SESSION['cashier_sid']) ||
    isset($_SESSION['chef_sid'])||
    isset($_SESSION['waiter_sid']))
{
        ...
        <div class="row">
          <?php
            echo "<a href='".$client->createAuthUrl()."'  >
                    <img src='images\btn_google_signin_dark_normal_web.png' style='display: block; margin-left: auto; margin-right: auto;'>
                  </a>";
          ?>
        </div>
		  		<div class="row">
