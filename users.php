...
<table>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<td><label for="balance">Balance</label><input disabled id="balance" name="'.$row['id'].'_balance" value="'.$balance.'" type="number" data-error=".errorTxt01"><div class="errorTxt01"></div></td></tr>'; 					
				}
				?>
                    </tbody>
</table>
