...
$longtude = $_POST['longtude'];
	$sql = "INSERT INTO orders (customer_id, payment_type, address, total, description, latitude, longtude) VALUES ($user_id, '$payment_type', '$address', $total, '$description', $latitude, $longtude)";
