    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="display-report.php" class="waves-effect waves-cyan"><i class="mdi-content-report"></i>Report</a>
                <li class="no-padding">
            ...
            <li ><a href="users.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Users</a>
                ...
                <table class="responsive-table display" cellspacing="0">
                    <thead>
                      <tr>
                        ...
                        <th data-field="delivered">#Delivered</th>
                        <th data-field="cancelled">#Cancelled by Customer</th>
                        <th data-field="total_sale">Total Sale(ETB)</th>							
                      </tr>
                    </thead>
