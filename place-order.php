          ...
          <div class="row">
            ...
            <div>
              <div class="card-panel">
                <div class="row">
                  <form class="formValidate col s12 m12 l6" id="formValidate" method="post" action="confirm-order.php"
                    ...
                    <div class="row">
                      <div class="input-field col s12">
                        ...
                        <select id="payment_type" name="payment_type">
                          ...
                          <option value="Cash On Delivery" <?php if(!$verified) echo 'disabled';?>>Cash on Delivery
                          </option>
                        </select>
                      </div>
                    </div>
                    <div class="row">
                      <div class="input-field col s12">
                        ...
                        <textarea name="address" id="address" class="materialize-textarea validate"
                          data-error=".errorTxt1"><?php echo $address;?></textarea>
                    ...
                    <input type="hidden" id="latitude" name="latitude" value=0 type=text>
                    <input type="hidden" id="longtude" name="longtude" value=0 type=text>
                    
                    <div class="row">
                      
                        <i class=" prefix"></i>
                          <?php
                            include 'map/user-map.php';
                          ?>
                  ...
                  <?php
                    ...
                    echo '<li class="collection-item">
                        <div class="row">
                            ...
                            <div class="col s3">
                                <span><strong>ETB. '.$total.'</strong></span>
                            </div>
                        </div>
                    </li>';
